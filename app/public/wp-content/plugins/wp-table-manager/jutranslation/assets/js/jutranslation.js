            ...
            success : function(data){
                ...
                $('#jutranslations-languages tbody tr[data-slug="'+ julanguage.extension + '"]').each(function(){
                    ...
                    if(!$line.attr('data-installed')){
                        $line.find('td .jutranslation-edition').addClass('disabled').attr({'data-toggle': 'tooltip','data-placement': 'top', 'data-original-title': 'Please install the latest available version first'}).tooltip();
                    } else {
                        $line.find('td .jutranslation-edition').attr({'data-toggle': 'tooltip','data-placement': 'top', 'data-original-title': 'Make sure you have the latest version installed before editing the original file'}).tooltip();
                    }
                    $line.find('td .jutranslation-override').attr({'data-toggle': 'tooltip','data-placement': 'top', 'data-original-title': 'Override the extension translation for your own needs, without modifying the original language file'}).tooltip();
                });
            }
        });
    });
