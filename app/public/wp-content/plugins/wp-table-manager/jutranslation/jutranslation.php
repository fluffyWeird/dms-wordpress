...
class Jutranslation
{
    ...
    public static function getInput()
    {
        ...
        wp_enqueue_script('jutranslation-bootbox', plugin_dir_url(self::$main_plugin_file) . 'jutranslation/assets/js/bootbox.js', array(), time());
        ...
        foreach ($languages as $language) {
            ...
            '" alt="loading"/></span><br/>';
            echo '<div style="display: inline-block; position: relative"><a data-toggle="tooltip" data-placement="top" class="jutranslation-override" href="#" data-language="' . esc_attr($language->languageCode) .
            ...
            if ($language->languageCode !== 'en-US') {
                ...
                echo '<div style="display: inline-block; position: relative"><a class="jutranslation-edition" href="#" data-language="' .
                    esc_attr($language->languageCode) . '" data-toggle="tooltip" data-placement="top">Edit original file</a></div>';
            }
